    ...
    public partial class vortexprofile : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_vortex_profile", x => x.vortex_profile_id);
                    table.ForeignKey(
                        name: "FK_vortex_profile_profile_profile_id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_vortex_profile_profile_id",
                table: "vortex_profile",
                column: "profile_id",
                unique: true);
        }
